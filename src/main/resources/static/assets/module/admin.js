            ...
            if (p) {
                ...
                if (s.length > 0) {
                    ...
                    if (r) {
                        ...
                        t.not(".layui-nav-itemed").children(".layui-nav-child").slideDown("fast",
                            function () {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res.success) {
                                    //清除tabs缓存
                                    if (top.layui.admin) {
                                        top.layui.admin.putTempData("indexTabs", null);
                                        top.layui.admin.putTempData("tabPosition", null)
                                    }
